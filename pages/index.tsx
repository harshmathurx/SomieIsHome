...
const Home: NextPage = () => {
  ...
  const getPercentageOfTripRemaining = (daysLeft: number,totalDays: number) => {
    return 100-Math.round((daysLeft/totalDays)*100);
    
  }

  const percentage = getPercentageOfTripRemaining(days,getDaysDifference(new Date("2024-01-30"),new Date("2024-05-11")))
